...
Function Add-ResourcesToCollection {
    ...
    [array]$ResourceArray = ($ui.Resources.Text -split '\n').Trim() | Where-Object { -not [string]::IsNullOrEmpty($_) }
...
Function Display-About {
    ...
    $UI.BlogLink, $UI.MDLink, $UI.GitLink, $UI.PayPalLink | ForEach-Object {
        $_.Add_Click({
...
Function Check-CurrentVersion {
    ...
    $XMLDocument.Add2Collection.Versions.Version | Sort-Object Value -Descending | ForEach-Object {
    ...
    [double]$CurrentVersion = $XMLDocument.Add2Collection.Versions.Version.Value | Sort-Object -Descending | Select-Object -First 1
